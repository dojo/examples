...
const cardStore: Store = createMemoryStore<Card>({
	data: [
		...
		{ id: 'card-2', cardType: 'momentum', name: 'Clear Objectives', description: 'You tell your team that knowing the goal of the task is far more important than understanding the specific words of the request.', score: 3, tagline: '', cardImage: 'images/horde.png', favouriteCount: 0 },
		...
		{ id: 'card-4', cardType: 'momentum', name: 'Code Reviews', description: 'The major benefit of your code review initiative wasn\'t reducing errors, but in the camaraderie it built between engineers.', score: 4, tagline: '', cardImage: 'images/horde.png', favouriteCount: 0 },
		...
		{ id: 'card-7', cardType: 'momentum', name: 'Communication', description: 'Your team communicates effectively, helping to avoid last minute scrambles and missed milestones.', score: 3, tagline: '', cardImage: 'images/horde.png', favouriteCount: 0 },
		...
		{ id: 'card-9', cardType: 'momentum', name: 'Delegation', description: 'You let your team know that you don\'t have to be involved in every decision. You trust them to use their judgement.', score: 2, tagline: '', cardImage: 'images/horde.png', favouriteCount: 0 },
		...
		{ id: 'card-12', cardType: 'momentum', name: 'Feedback', description: 'You encourage the team to raise issues as they see them instead of letting them fester, even if the issue is you.', score: 2, tagline: '', cardImage: 'images/horde.png', favouriteCount: 0 },
		...
		{ id: 'card-14', cardType: 'momentum', name: 'Future Proofing', description: 'Your team not only solves the immediate problem, but works hard to ensure they aren\'t creating new ones down the road.', score: 1, tagline: '', cardImage: 'images/horde.png', favouriteCount: 0 },
